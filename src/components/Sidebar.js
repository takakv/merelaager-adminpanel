  ...
  return (
    <nav className="c-admin-nav">
      <ul className="u-list-blank">
        <li className="last">
          <Link className="_link" to="/" onClick={() => dispatch(setTitle("Kambüüs"))}>
            Kambüüs
          </Link>
        </li>
        <li>
          <Link className="_link" to="/lapsed/" onClick={() => dispatch(setTitle("Lapsed"))}>
            Lapsed
          </Link>
        </li>
        <li>
        ...
        <li>
          <Link className="_link" to="/sargid/" onClick={() => dispatch(setTitle("Särgid"))}>
            Särgid
          </Link>
        </li>
      </ul>
